                    ...
                    <div class="col-xs-12 col-md-12">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('users.updatePrivacy', $user->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label class="radio-inline">
                                        <input name="message" id="message1" value="any" type="radio"  @if (empty($user->privacy->message) !== true && $user->privacy->message === 'any')  checked="checked" @endif /><span class="form-label">接收所有</span>
                                    </label>
                                    <label class="radio-inline">
                                        <input name="message" id="message2" value="only" type="radio" @if (empty($user->privacy->message) !== true && $user->privacy->message === 'only') checked="checked" @endif /><span class="form-label" title="我关注的、关注我的，回复过站内信的">仅限相关</span>
                                    </label>
                                    <label class="radio-inline">
                                        <input name="message" id="message3" value="none" type="radio" @if (empty($user->privacy->message) !== true && $user->privacy->message === 'none') checked="checked" @endif /><span class="form-label">拒绝所有</span>
                                    </label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea name="blacklist" id="blacklist" class="form-control" rows="3" placeholder="请填入您想列入黑名单的用户（一行一个）">{{ $blacklist or null }}</textarea>
