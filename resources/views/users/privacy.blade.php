                    ...
                    <div class="col-xs-12 col-md-12">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('user.updatePrivacy', $user->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label class="radio-inline">
                                        <input name="message" id="message1" value="any" type="radio" /><span class="form-label">接收所有</span>
                                    </label>
                                    <label class="radio-inline">
                                        <input name="message" id="message2" value="only" type="radio" /><span class="form-label" title="我关注的、关注我的，回复过站内信的">仅限相关</span>
                                    </label>
                                    <label class="radio-inline">
                                        <input name="message" id="message3" value="none" type="radio" /><span class="form-label">拒绝所有</span>
                                    </label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label class="radio-inline">
                                        <input name="email" id="email1" value="any" type="radio" /><span class="form-label">接收所有</span>
                                    </label>
                                    <label class="radio-inline">
                                        <input name="email" id="email2" value="only" type="radio" /><span class="form-label">仅限有关</span>
                                    </label>
                                    <label class="radio-inline">
                                        <input name="email" id="email3" value="none" type="radio" /><span class="form-label">拒绝所有</span>
                                    </label>
