...
@forelse ($likes as $notification)
                        <div class="media media-quirk" id="notification{{ $notification->id }}">
                            <div class="media-left">
                                <img class="media-object img-circle avatar-sm" src="{{ $notification->notifiable->liker->gravatar(48) }}" />
                            </div>
                            ...
                            <div class="media-right">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu{{ $notification->id }}">
                                        <li><a class="caution bg-primary" href="{{ route('notification.showLike', $notification->id) }}"><i class="glyphicon glyphicon-eye-open" aria-hidden="true"></i>查看</a></li>
                                        <li><a class="caution bg-danger" href="javascript:void(0);" data-target="#notification{{ $notification->id }}" data-handler="{{ route('notification.deleteLike', $notification->id) }}"><i class="glyphicon glyphicon-trash" aria-hidden="true"></i>删除</a></li>
                                        <li role="separator" class="divider"></li>
                                        <li><a class="caution bg-danger" href="#blacklist-{{ $notification->notifiable->liker->id }}"><i class="glyphicon glyphicon-ban-circle" aria-hidden="true"></i>加入黑名单</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
