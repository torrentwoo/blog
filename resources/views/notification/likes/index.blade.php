                            ...
                            <div class="media-right">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu{{ $notification->id }}">
                                        ...
                                        <li><a class="caution bg-danger" href="javascript:void(0);" data-toggle="#notification{{ $notification->id }}" data-handler="{{ route('notification.deleteLike', $notification->id) }}"><i class="glyphicon glyphicon-trash" aria-hidden="true"></i>删除</a></li>
