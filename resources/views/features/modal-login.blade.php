                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="ajax-password" class="control-label">密码</label>
                                        <input type="password" name="password" id="ajax-password" class="form-control" placeholder="登录密码" />
                                    </div>
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="remember" id="ajax-remember" />
