                            ...
                            <div class="media-right">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu{{ $index }}">
                                        <li><a class="caution bg-primary" href="{{ route('messages.show', $message->first()->sender->id) }}"><i class="glyphicon glyphicon-eye-open" aria-hidden="true"></i>回复</a></li>
...
@endif
                            ...
                            <div class="media-right">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu{{ $index }}">
                                        <li><a class="caution bg-primary" href="{{ route('messages.show', $message->first()->recipient->id) }}"><i class="glyphicon glyphicon-eye-open" aria-hidden="true"></i>回复</a></li>
